...
mods = {
    ...
    help: function() {
        return [
            'test',
            'grover tells you what is wrong: run from inside a module to test it, pass extra modules to test them too. From ./src to test all. Add --coverage to generate a coverage report. --cli to run only cli tests'
        ];
    }
};
